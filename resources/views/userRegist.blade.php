...
<form action="{{$url}}" method="POST">
    ...
    <div class="row">
      ...
      <div class="col-sm-7 col-md-7 box even">
          <input type="text" name="nickname" maxlength="20" style="width: 100%;" value="{{$nickname}}" {{$readonly}} required>
      </div>
      <div class="col-sm-1 col-md-1"></div>
    </div>
    <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-sm-7 col-md-7 box odd">
          <label>〒<input type="text" name="postalcode"  onKeyUp="AjaxZip3.zip2addr(this,'','address','address');" value="{{$postalcode}}" {{$readonly}} required></label><br>
          <input type="text" name="address" maxlength="100" style="width: 80%;" value="{{$address}}" readonly {{$readonly}}>(住所検索結果を反映)
      </div>
      <div class="col-sm-1 col-md-1"></div>
    </div>
    <div class="row">
      ...
      <div class="col-sm-7 col-md-7 box even">
          ...
          <input type="checkbox" id="jobkind11" name="jobkind[]" value="11" <?php if (!empty($job_kind)) {  !is_bool(array_search('11', $job_kind)) ? "checked='checked'" : "";} ?> {{$readonly}}>
